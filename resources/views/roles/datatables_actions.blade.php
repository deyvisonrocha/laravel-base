{!! Form::open(['route' => ['roles.destroy', $id], 'method' => 'delete']) !!}
    @can('roles.show')
        <a type="button" href="{!! route('roles.show', [$id]) !!}" class='btn btn-success btn-sm tooltips' data-toggle="tooltip" data-placement="top" title="{{ trans('messages.show') }}"><i class="fa fa-file-text-o"></i></a>
    @endcan
    @can('roles.edit')
        <a href="{!! route('roles.edit', [$id]) !!}" class='btn btn-primary btn-sm tooltips' data-toggle="tooltip" data-placement="top" title="{{ trans('messages.edit') }}"><i class="fa fa-edit"></i></a>
    @endcan
    @can('roles.destroy')
